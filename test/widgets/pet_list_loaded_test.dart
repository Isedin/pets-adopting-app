...
void main() {
  testWidgets('should display all given Pets', (tester) async {
    final List<Pet> tPets = [
      Pet(id: "1", name: "Kira", species: Species.dog, age: 10, weight: 250.0, height: 20.0, isFemale: true),
      Pet(id: "2", name: "Space", species: Species.fish, age: 3, weight: 400.0, height: 40.0, isFemale: false),
    ];
    ...
    await expectLater(find.byType(MaterialApp), matchesGoldenFile('pet_list_loaded.png'));
  });
}
